...
@class SpringBoard; @class SBHomeHardwareButton; @class SBLockScreenViewControllerBase; @class SBFluidSwitcherGestureManager; @class SBLockHardwareButton; @class SBLockStateAggregator; 
