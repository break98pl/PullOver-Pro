...
@class SBLockScreenViewControllerBase; @class SBLockStateAggregator; @class SBLockHardwareButton; @class SBFluidSwitcherGestureManager; @class SpringBoard; @class SBHomeHardwareButton; 
